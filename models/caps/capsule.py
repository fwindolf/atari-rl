...
class Capsule(nn.Module):
    def __init__(self, in_unit, in_channel, num_unit, unit_size, use_routing, num_routing):
    ...
    def squash(tensor, dim=-1):
        ...
        # Non linear squashing function so that short vectors are squashed to 0 
        # and long vectors get shrunk to a val lower than 1
